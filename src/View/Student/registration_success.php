                ...
                <div class="d-flex justify-content-between align-items-center py-2">
                    ...
                    <div>
                        <?php if ($model['student']->is_re_registered): ?>
                            ...
                            <span class="badge bg-light-success text-success px-2 py-1 fw-bold" style="font-size: 0.75rem;">
                                Sudah Daftar Ulang
                            </span>

                        <?php else: ?>

                            <span class="badge bg-light-warning text-warning px-2 py-1 fw-bold" style="font-size: 0.75rem;">
                                Belum Daftar Ulang
                            </span>
