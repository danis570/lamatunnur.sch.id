    ...
    <div class="d-flex align-items-center justify-content-center min-vh-100 p-3">
        <div class="card success-card m-0">
            <div class="card-body p-4 p-sm-5 text-center">
                ...
                <!-- Teks Status -->
                <h3 class="fw-bold text-dark mb-2">Pendaftaran Berhasil!</h3>
                <p class="text-muted mb-4 fs-6">Data santri telah disimpan dengan aman di dalam sistem kami.</p>

                <!-- Box Informasi Minimalis -->
                <div class="info-box p-3 mb-4 text-start">
                    ...
                    <div class="d-flex justify-content-between align-items-center py-2 border-bottom border-light">
                        ...
                        <span class="fw-semibold text-dark text-end"
                            style="max-width: 60%; word-break: break-word;"><?= htmlspecialchars($model['student']->full_name) ?></span>
                    </div>

                    <div class="d-flex justify-content-between align-items-center py-2 border-bottom border-light">
                        <span class="text-muted small">NIK</span>
                        <span
                            class="fw-semibold text-dark"><?= htmlspecialchars($model['student']->student_nik) ?></span>
                    </div>
                    ...
                    <div class="d-flex justify-content-between align-items-center py-2">
                        ...
                        <div>
                            <?php if ($model['student']->is_re_registered): ?>
                                <span class="badge bg-light-success text-success px-2.5 py-1.5 fw-bold"
                                    style="font-size: 0.75rem;">Sudah Daftar Ulang</span>
                            <?php else: ?>
                                <span class="badge bg-light-warning text-warning px-2.5 py-1.5 fw-bold"
                                    style="font-size: 0.75rem;">Belum Daftar Ulang</span>
                            <?php endif; ?>
                        </div>
                    </div>
                </div>

                <!-- Tombol Aksi Flat Clean -->
